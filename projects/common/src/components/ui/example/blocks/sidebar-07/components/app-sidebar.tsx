...
import { NavMain } from "@common/components/ui/example/blocks/sidebar-07/components/nav-main";
import { NavProjects } from "@common/components/ui/example/blocks/sidebar-07/components/nav-projects";
